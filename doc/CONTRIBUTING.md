...
We have a few requests for those that are interested in contributing, and we've outlined them below.
...
This project uses PHPUnit. When you write your tests, please make sure they're in line with the existing tests.
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/cakephp-cache-engines
   # Navigate to the newly cloned directory
   cd cakephp-cache-engines
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Traackr/cakephp-cache-engines
   ```
