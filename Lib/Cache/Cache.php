<?php
/**
 * The following is a modified version of https://github.com/cakephp/cakephp/blob/2.10.22/lib/Cake/Cache/Cache.php
 * The modifications are limited to the addition of the the `$parentKey` parameter to the `write` method.
 */
/**
 ...
 */
	public static function write($key, $value, $config = 'default', $parentKey = '') {
		...
		$success = static::$_engines[$config]->write($settings['prefix'] . $key, $value, $settings['duration'], $parentKey);
