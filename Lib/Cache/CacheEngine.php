<?php
/**
 * The following is a modified version of https://github.com/cakephp/cakephp/blob/2.10.22/lib/Cake/Cache/CacheEngine.php
 ...
 */
	abstract public function write($key, $value, $duration, $parentKey = '');
